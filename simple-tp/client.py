#!/usr/bin/env python3
"""
Simple Transaction Processor Client
Client for testing the simple transaction processor.
"""
...
class SimpleTPClient:
    """Client for Simple Transaction Processor."""
    ...
    def __init__(self, base_url='http://rest-api:8008'):
        ...
        print(f"Simple TP Client initialized")
...
def main():
    """Test the simple transaction processor."""
    print("🚀 Simple TP Client Test")
    print("=" * 30)
    
    client = SimpleTPClient()
